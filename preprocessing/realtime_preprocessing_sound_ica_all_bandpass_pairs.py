...
save_directory = r'/home/marco/Documents/GitHub/tms_eeg_decoding/data/frequency_bandstop'
mep_directory = r'/home/marco/Documents/GitHub/tms_eeg_decoding/data/frequency_bandstop'
...
#subject_indices = subject_indices = [1,2,3,4,7,9,11,13,14,18,22,24,25,26,27,29,31,33,34,35,39,41,42,43,45,46,47,48,51,52,53,55,56,57,59,60,62,63,65,66,67,69,70,71,72,73,74,76,79,80,83,86,88,92,100,102]
subject_indices = [1]
...
for freq_pair_name, freq_pair_range in frequency_pairs.items():
    ...
    for subject_file in subject_files:
        ...
        class ICAPreprocessor:
            def __init__(self, num_channels, n_components=25, tmin=0,  raw_info=None, eeg_picks=None, montage=None, freq_pair=None):
        ...
        class SOUNDPreprocessor:
            def __init__(self, num_of_eeg_channels, sfreq, resample_freq_hz, leadfield_matrix, raw_info, eeg_picks, montage=None, ica_preprocessor=None, freq_pair=None):
                ...
                self.mne_filter = MNEFilter(f_ranges=self.freq_pair, sfreq=self.resample_freq_hz, filter_length="1000ms", verbose=False)
                # Initialize the Resampler and MNEFilter
        ...
        save_path = os.path.join(save_directory, f'subject_{subject_number}_mep_py_rt_interaction_{freq_pair_name}.csv')
        ...
        save_path = os.path.join(save_directory, f'subject_{subject_number}_freq_interaction_{freq_pair_name}_eeg_preprocessed_py_interaction_test.fif')
